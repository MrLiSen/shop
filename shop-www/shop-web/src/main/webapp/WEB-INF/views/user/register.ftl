                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if(data.resultCode == 0) {// 失败打印消息
                            ...
                            if (redirectUrl == null || $.trim(redirectUrl).length < 1) {
...
//                $.post("/sms/send", {'phone':phone}, function(data) {
...
//            });
            ...
            $("#sendVerifyCodeBtn").click(function() {
                ...
                $.post("${ctx}/sms/send", {phone: phone}, function(resp) {
                    if (resp.resultCode == 1) { // 发送成功
                        downtime ();
                    } else {
